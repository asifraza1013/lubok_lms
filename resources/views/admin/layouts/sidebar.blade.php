        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="{{ Nav::isResource('admin/country') }} {{ Nav::isResource('admin/state') }} {{ Nav::isResource('admin/city') }} treeview">
            ...
            <ul class="treeview-menu">
              <li class="{{ Nav::isResource('country') }}"><a href="{{route('country.index')}}"><i class="flaticon-flag"></i>{{ __('adminstaticword.Country') }}</a></li>
              <li class="{{ Nav::isResource('state') }}"><a href="{{route('state.index')}}"><i class="flaticon-placeholder"></i>{{ __('adminstaticword.State') }}</a></li>
              <li class="{{ Nav::isResource('city') }}"><a href="{{route('city.index')}}"><i class="flaticon-home"></i>{{ __('adminstaticword.City') }}</a></li>
            </ul>
          </li>
          ...
          <!-- <li class="{{ Nav::isResource('addon') }}"><a href="{{url('addon')}}"><i class="flaticon-real-state" aria-hidden="true"></i><span>{{ __('adminstaticword.Addon') }} {{ __('adminstaticword.Manager') }}</span></a></li> -->
