            ...
            <div class="row">
                ...
                <div class="col-md-3 offset-2">
                    <div class="copyright-social">
                        ...
                        <p class="text-center text-white">{{ $cpy_txt }}</p>
                    </div>
                </div>
            </div>
        </div>
