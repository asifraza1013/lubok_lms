    ...
    <div class="container-fluid">
        ...
        <div class="navigation fullscreen-search-block">
            ...
            <div class="logo">
                ...
                <a href="{{ url('/') }}"><img src="{{ asset('images/logo/'.$gsetting->logo) }}" class="img-fluid"
                        alt="logo"></a>
                @else()
                <a href="{{ url('/') }}">
                    <b>
                                ...
                                <h4 class="panel-title">
                                    <a role="button" data-toggle="collapse" data-parent="#accordion"
                                        ...
                                        <i class="fa {{ $cate->icon }} rgt-10"></i> <label class="prime-cat"
                                            data-url="{{ route('category.page',['id' => $cate->id, 'category' => $cate->title]) }}">{{
                                            str_limit($cate->title, $limit = 20, $end = '..') }}</label>
                                    </a>
                                </h4>
                            </div>
                                            ...
                                            <h4 class="panel-title">
                                                <a class="collapsed" role="button" data-toggle="collapse"
                                                    ...
                                                    <i class="fa {{ $sub->icon }} rgt-10"></i> <label class="sub-cate"
                                                        data-url="{{ route('subcategory.page',['id' => $sub->id, 'category' => $sub->title]) }}">{{
                                                        str_limit($sub->title, $limit = 15, $end = '..') }}</label>
                                        ...
                                        <div id="collapseeleven{{ $sub->id }}" class="panel-collapse collapse"
                                            ...
                                            <div class="panel-body sub-cat">
                                                <i class="fa {{ $child->icon }} rgt-10"></i> <label class="child-cate"
                                                    data-url="{{ route('childcategory.page',['id' => $child->id, 'category' => $child->title]) }}">{{
                                                    $child->title }} </label>
                                            </div>
                                            @endif
                                            @endforeach
                ...
                <div class="sidebar-nav-icon">
                    <ul>
                        ...
                        <a href="{{ route('active.courses') }}" title="Watchlist">
                            <li><i class="fas fa-swatchbook"></i>{{ __('frontstaticword.Watchlist') }}</li>
                        </a>
                        @endif
                        @endif
